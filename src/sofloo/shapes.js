...
export function newTriangleConfigGenerator(width, height, seeder) {
  // Idea here is that we have a core which the generated triangles follow as their center.
  // The core has a depth and an x y location. (xyz)
  // Each shape then has an amount of steps and a function which defines
  // how it progresses towards the core.
  // Ideally these shapes share a similair descent function.
  // Future plans:
  // Be able to define the amount of shapes and what base shape they are built from.
  console.log('Use seeder triangle multi', seeder);
}
